    ...
    <div class="modal-dialog modal-md modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-header align-items-center">
                <h5 class="mb-0" id="modalTitle">新增資訊</h5>
                <button type="button" class="btn-close ms-auto" data-bs-dismiss="modal" aria-label="關閉"></button>
            </div>
                                        ...
                                        <div class="card border-0 bg-light">
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="form-text">數字越大，在跑馬燈中顯示越前面（0-10）</div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-select" name="msg_type">
                                                        ...
                                                        <option value="SYSTEM_NOTICE">系統通知</option>
                                                ...
                                                <!-- 公告顯示功能已註解（資料表中無此欄位，使用 msg_status 控制） -->
                                                <!-- <div class="mb-3">
