...
--
-- 傾印資料表的資料 `pereviewdata`
--

INSERT INTO `pereviewdata` (`peer_ID`, `period_ID`, `pe_target_ID`, `pe_u_ID`, `score`, `peer_comment`, `created_d`, `petarget_u_ID`) VALUES
(1, 1, 3, '110534231', 3, '123', '2025-11-28 10:09:57', '110534205'),
(2, 1, 3, '110534231', 3, '1', '2025-11-28 10:09:57', '110534215'),
(3, 1, 3, '110534231', 3, '32', '2025-11-28 10:09:57', '110534221');
...
(1, '1213', 'in', '2025-11-27 10:07:00', '2025-11-29 10:07:00', '2025-11-28 10:07:27', 'tengteng', '1,4');
...
(1, 1, '專題日總彙', 3, 1, '2025-11-06 12:14:02', '', 1),
...
--
ALTER TABLE `enrollmentdata`
  MODIFY `enroll_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
...
--
ALTER TABLE `formtargetdata`
  MODIFY `ft_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '目標對象ID';
...
--
ALTER TABLE `pereviewdata`
  MODIFY `peer_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '互評紀錄ID', AUTO_INCREMENT=4;
