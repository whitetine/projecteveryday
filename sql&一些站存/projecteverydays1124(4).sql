...
(44, '109534201', 2, 2, 6, 5, 1, '2025-11-13 10:21:43'),
(45, '109534206', 2, 2, 6, 5, 1, '2025-11-13 10:21:43'),
(46, '109534207', 2, 2, 6, 5, 1, '2025-11-13 10:21:43'),
...
(71, 'toshiko', 2, NULL, 4, NULL, 0, NULL),
(72, 'beckchou', 2, NULL, 4, NULL, 0, NULL),
...
INSERT INTO `formdata` (`form_ID`, `form_name`, `form_des`, `form_category`, `form_status`, `form_start_d`, `form_end_d`, `form_created_u_ID`, `form_created_d`, `form_updated_d`, `form_updated_u_ID`, `form_remark`) VALUES
(2, '康寧學校財團法人康寧大學 資管科專題初審申請單', '', '專題初審單', 1, NULL, NULL, 'uknim', '2025-11-24 13:13:21', NULL, NULL, '資訊軟體開發組');
...
--
-- 傾印資料表的資料 `formquestiondata`
--

INSERT INTO `formquestiondata` (`fq_ID`, `form_ID`, `fq_order`, `fq_title`, `fq_type`, `fq_required`, `fq_placeholder`, `fq_options`, `fq_remark`) VALUES
(1, 2, 1, '專題目的(系統、研究等想解決什麼問題？)', 'long_text', 1, NULL, NULL, '{\"remark\":\"請簡要說明\",\"option_source\":\"manual\"}'),
(2, 2, 2, '專題功能或架構 (系統、研究主要功能為何？)', 'long_text', 1, NULL, NULL, '{\"remark\":\"請簡要說明\",\"option_source\":\"manual\"}'),
(3, 2, 3, '專題主要使用何種工具(如何種程式語言？模式? 函數等？)', 'long_text', 1, NULL, NULL, '{\"remark\":\"請簡要說明\",\"option_source\":\"manual\"}'),
(4, 2, 4, '其他 (系統開發組請回答使用何種資料庫？軟體應用請回答預期結論與貢獻?)', 'long_text', 1, NULL, NULL, '{\"remark\":\"請簡要說明\",\"option_source\":\"manual\"}'),
(5, 2, 5, '競賽規劃', 'long_text', 1, NULL, NULL, '{\"remark\":\"\",\"option_source\":\"manual\"}');
...
(1, 1, '專題管理', 3, 1, '2025-11-06 12:14:02', '', 1),
(2, 1, '微旅日記', 3, 1, '2025-11-06 12:14:02', '', 1),
(3, 1, '昊德經絡', 2, 0, '2025-11-06 12:14:02', '', 1),
(4, 1, '產學合作', 3, 1, '2025-11-06 12:14:02', '', 1),
(5, 2, '逮妮娜組', 3, 1, '2025-11-06 12:14:02', '', 1),
(6, 3, '測試', 3, 1, '2025-11-06 12:14:02', '', 1),
(7, 1, '測試測試測試', 3, 1, '2025-11-24 11:06:02', 'uploads/team_apply/apply_110534226_1763953547.jpg', 1),
(8, 2, '測試測試測試', 3, 1, '2025-11-24 13:14:18', 'uploads/team_apply/apply_110534212_1763961247.jpg', 1);
...
(7, '110534206', 1, '2025-11-24 11:06:02', 'uploads/team_apply/apply_110534226_1763953547.jpg'),
(7, '110534226', 1, '2025-11-24 11:06:02', 'uploads/team_apply/apply_110534226_1763953547.jpg'),
(7, 'scottli', 1, '2025-11-24 11:06:02', 'uploads/team_apply/apply_110534226_1763953547.jpg'),
(8, '110534210', 1, '2025-11-24 13:14:18', 'uploads/team_apply/apply_110534212_1763961247.jpg'),
(8, '110534212', 1, '2025-11-24 13:14:18', 'uploads/team_apply/apply_110534212_1763961247.jpg'),
(8, 'yang', 1, '2025-11-24 13:14:18', 'uploads/team_apply/apply_110534212_1763961247.jpg');
...
('110534202', '110534202', '賴逢尼', '110534202@stu.ukn.edu.tw', '', NULL, 1, '2025-11-06 11:28:35'),
...
('110534207', '110534207', '蔡沁妤', '110534207@stu.ukn.edu.tw', '', NULL, 1, '2025-11-06 11:28:35'),
...
('110534235', '110534235', '周佳儀', '110534235@stu.ukn.edu.tw', '', NULL, 1, '2025-11-06 11:28:35'),
...
('110534242', '110534242', '郭紘丞', '110534242@stu.ukn.edu.tw', '', NULL, 1, '2025-11-06 11:28:35'),
...
('tengteng', '1234', '陳宗騰', 'ttchen@ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
...
--
ALTER TABLE `enrollmentdata`
  MODIFY `enroll_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
...
--
ALTER TABLE `formanswerdata`
  MODIFY `fa_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '答案ID';
...
--
ALTER TABLE `formquestiondata`
  MODIFY `fq_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '題目ID', AUTO_INCREMENT=6;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `formsubdata`
--
ALTER TABLE `formsubdata`
  MODIFY `fs_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '申請紀錄ID';
...
--
ALTER TABLE `teamapply`
  MODIFY `tap_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=5;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `teamdata`
--
ALTER TABLE `teamdata`
  MODIFY `team_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '團隊ID', AUTO_INCREMENT=9;
