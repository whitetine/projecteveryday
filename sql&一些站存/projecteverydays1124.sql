...
(1, '專題申請通知', '學生 賴定宏 提交了專題申請表，請前往審核。', NULL, 'system', NULL, 'SYSTEM_NOTICE', 1, '2025-11-23 23:59:02', NULL, '2025-11-23 23:59:02'),
(2, '專題申請通過通知', '您的專題申請「321」已通過審核，團隊已成功建立。', NULL, 'system', NULL, 'SYSTEM_NOTICE', 1, '2025-11-24 01:21:49', NULL, '2025-11-24 01:21:49');
...
INSERT INTO `perioddata` (`period_ID`, `period_title`, `period_type`, `period_start_d`, `period_end_d`, `pe_created_d`, `pe_created_u_ID`, `pe_target_ID`) VALUES
(1, '1', 'in', '2025-11-23 04:53:00', '2025-11-24 04:53:00', '2025-11-23 04:53:18', 'uknim', 'ALL'),
(2, '1', 'in', '2025-11-23 04:53:00', '2025-11-24 04:53:00', '2025-11-23 04:53:30', 'uknim', 'ALL');
...
--
-- 傾印資料表的資料 `petargetdata`
--

INSERT INTO `petargetdata` (`pe_target_ID`, `period_ID`, `pe_team_ID`, `pe_class_ID`, `pe_cohort_ID`, `pe_grade_no`, `status_ID`) VALUES
(1, 1, 1, NULL, 3, NULL, 0),
(2, 1, 2, NULL, 3, NULL, 0),
(3, 2, 1, NULL, 3, NULL, 0),
(4, 2, 2, NULL, 3, NULL, 0),
...
(7, 2, '321', 3, 1, '2025-11-24 01:21:49', 'uploads/team_apply/apply_110534212_1763913542.jpg');
...
(7, '110534210', 1, '2025-11-24 01:21:49', 'uploads/team_apply/apply_110534212_1763913542.jpg'),
(7, '110534212', 1, '2025-11-24 01:21:49', 'uploads/team_apply/apply_110534212_1763913542.jpg'),
(7, 'toshiko', 1, '2025-11-24 01:21:49', 'uploads/team_apply/apply_110534212_1763913542.jpg');
...
--
ALTER TABLE `formdata`
  MODIFY `form_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '表單ID';

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `formquestiondata`
--
ALTER TABLE `formquestiondata`
  MODIFY `fq_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '題目ID';
...
--
ALTER TABLE `perioddata`
  MODIFY `period_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=3;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `petargetdata`
--
ALTER TABLE `petargetdata`
  MODIFY `pe_target_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=8;
...
--
ALTER TABLE `teamapply`
  MODIFY `tap_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=2;
