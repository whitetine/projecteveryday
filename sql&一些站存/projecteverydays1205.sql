...
(1, NULL, 1, '完成登入系統', '', '2025-12-04 11:43:00', '2025-12-06 04:37:00', NULL, NULL, NULL, NULL, NULL, 1, 1, '2025-12-04 04:37:54');
...
--
ALTER TABLE `suggest`
  MODIFY `suggest_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '主鍵', AUTO_INCREMENT=4;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `suggestfrom`
--
ALTER TABLE `suggestfrom`
  MODIFY `sf_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號';
