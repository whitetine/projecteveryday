...
--
-- 資料表結構 `changerecordsdata`
--

CREATE TABLE `changerecordsdata` (
  `cr_ID` int(11) NOT NULL COMMENT '流水號',
  `rd_ID` int(11) NOT NULL COMMENT '資料列ID(對應成果資料列表)',
  `cr_type` enum('INSERT','UPDATE','DELETE') NOT NULL COMMENT '動作類型',
  `cr_record` varchar(255) DEFAULT NULL COMMENT '原始資料',
  `cr_update_data` varchar(255) DEFAULT NULL COMMENT '更新後資料',
  `cr_reason` varchar(255) DEFAULT NULL COMMENT '異動原因',
  `cr_u_ID` varchar(25) NOT NULL COMMENT '異動人',
  `cr_update_d` datetime NOT NULL DEFAULT current_timestamp() COMMENT '異動日期'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='存放預期成果異動紀錄';
...
(6, '110屆初審申請單', '', 'pdf', 'uploads/doc/doc_20260108_024159_c4a6.pdf', 0, 1, '2025-02-27 10:00:00', '2026-03-31 10:00:00', 1, 'uknim', '2026-01-08 09:41:59'),
(7, '110屆初審單', '', 'pdf', 'uploads/doc/doc_20260108_024255_ea5b.pdf', 0, 1, NULL, '2026-06-30 10:00:00', 1, 'uknim', '2026-01-08 09:42:55'),
(8, '110屆專題審查申請單', '', 'pdf', 'uploads/doc/doc_20260108_024541_6a6f.pdf', 0, 1, NULL, NULL, 1, 'uknim', '2026-01-08 09:45:41'),
(9, '110屆專題審查意見回覆表', '', 'pdf', 'uploads/doc/doc_20260108_024616_bd7a.pdf', 0, 0, NULL, NULL, 1, 'uknim', '2026-01-08 09:46:16'),
(10, '期中進度審查申請表', '', 'pdf', 'uploads/doc/doc_20260108_024650_62e3.pdf', 0, 1, NULL, NULL, 1, 'uknim', '2026-01-08 09:46:50');
...
(2, 7, 1, 'uknim', '', 'uploads/images/img_695f0d5563fe1.png', '2026-01-08 09:50:13', NULL, NULL, NULL, 0);
...
(107, 'adm_uknim1', 3, NULL, 7, NULL, 1, '2026-01-08 05:48:09'),
(108, 'adm_uknim2', 3, NULL, 7, NULL, 1, '2026-01-08 05:48:09');
...
CREATE TABLE `exresultdata` (
  `sfd_ID` int(11) NOT NULL COMMENT '流水號',
  `sfd_name` varchar(50) NOT NULL COMMENT '檔名',
  `sfd_team_ID` int(11) NOT NULL COMMENT '團隊ID',
  `sfd_u_ID` varchar(25) NOT NULL COMMENT '建立人',
  `sfd_submit_d` date DEFAULT NULL COMMENT '繳交日期',
  `sfd_created_d` datetime NOT NULL DEFAULT current_timestamp() COMMENT '建立日期'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='存放預期成果資料';
...
CREATE TABLE `exresultddata` (
  `rd_ID` int(11) NOT NULL COMMENT '流水號',
  `sfd_ID` int(11) NOT NULL COMMENT '資料列ID(對應預期成果列表)',
  `rd_title` varchar(255) NOT NULL COMMENT '標題',
  `rd_content` varchar(255) NOT NULL COMMENT '內容',
  `rd_u_ID_a` varchar(25) NOT NULL COMMENT '負責人',
  `rd_u_ID_b` varchar(25) DEFAULT NULL COMMENT '完成人',
  `rd_status` tinyint(4) NOT NULL COMMENT '狀態',
  `rd_finish_d` datetime DEFAULT NULL COMMENT '完成時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='存放預期成果明細資料';
...
(31, '專題申請通知', '學生 陳思維 提交了專題申請表，請前往審核。', NULL, 'system', NULL, 'SYSTEM_NOTICE', 1, '2026-01-07 23:22:40', NULL, '2026-01-07 23:22:40'),
(32, '未加入團隊學生通知', '您好，該班級有 11 位學生尚未加入團隊：\n\n林宜伶（110534101）、葉芃孝（110534104）、唐佳臻（110534107）、林妍妡（110534108）、蕭鈺萱（110534109）、楊勝維（110534114）、潘星穎（110534118）、石盛文（110534120）、王育圻（110534125）、鍾雨凝（110534133）、黃冠錡（110534145）\n\n請協助提醒學生加入團隊。', NULL, 'uknim', NULL, 'SYSTEM_NOTICE', 1, '2026-01-08 05:18:12', NULL, '2026-01-08 05:18:12'),
(33, '未加入團隊學生通知', '您好，該班級有 12 位學生尚未加入團隊：\n\n林奕璁（110534209）、汪俊成（110534210）、陳思維（110534211）、賴定宏（110534212）、蔡承達（110534224）、謝秉哲（110534228）、吳嘉緯（110534229）、蔡愷慈（110534232）、李玉馨（110534233）、蔡宏恩（110534237）、黃哲渝（110534238）、郭紘丞（110534242）\n\n請協助提醒學生加入團隊。', NULL, 'uknim', NULL, 'SYSTEM_NOTICE', 1, '2026-01-08 05:18:12', NULL, '2026-01-08 05:18:12'),
(34, '未加入團隊學生通知', '您好，該班級有 11 位學生尚未加入團隊：\n\n林宜伶（110534101）、葉芃孝（110534104）、唐佳臻（110534107）、林妍妡（110534108）、蕭鈺萱（110534109）、楊勝維（110534114）、潘星穎（110534118）、石盛文（110534120）、王育圻（110534125）、鍾雨凝（110534133）、黃冠錡（110534145）\n\n請協助提醒學生加入團隊。', NULL, 'uknim', NULL, 'SYSTEM_NOTICE', 1, '2026-01-08 05:18:47', NULL, '2026-01-08 05:18:47'),
(35, '未加入團隊學生通知', '您好，該班級有 12 位學生尚未加入團隊：\n\n林奕璁（110534209）、汪俊成（110534210）、陳思維（110534211）、賴定宏（110534212）、蔡承達（110534224）、謝秉哲（110534228）、吳嘉緯（110534229）、蔡愷慈（110534232）、李玉馨（110534233）、蔡宏恩（110534237）、黃哲渝（110534238）、郭紘丞（110534242）\n\n請協助提醒學生加入團隊。', NULL, 'uknim', NULL, 'SYSTEM_NOTICE', 1, '2026-01-08 05:18:47', NULL, '2026-01-08 05:18:47'),
(36, '未加入團隊學生通知', '您好，該班級有 11 位學生尚未加入團隊：\n\n林宜伶（110534101）、葉芃孝（110534104）、唐佳臻（110534107）、林妍妡（110534108）、蕭鈺萱（110534109）、楊勝維（110534114）、潘星穎（110534118）、石盛文（110534120）、王育圻（110534125）、鍾雨凝（110534133）、黃冠錡（110534145）\n\n請協助提醒學生加入團隊。', NULL, 'uknim', NULL, 'SYSTEM_NOTICE', 1, '2026-01-08 06:13:45', NULL, '2026-01-08 06:13:45'),
(38, '專題申請通過通知', '您的專題申請「金齁甲調查局」已通過審核，團隊已成功建立。', NULL, 'system', NULL, 'SYSTEM_NOTICE', 1, '2026-01-08 13:19:01', NULL, '2026-01-08 13:19:01');
...
(1, 2, '109學年度專題資料', '{\"class_ID\":[]}', '2025-12-10 10:00:00', '2025-12-10 23:56:00', NULL, NULL, 1, 'uknim', '2025-12-10 22:15:23');
...
(1, 1, 3, 'uploads/project_posters/188184608.png', NULL, '{\"intro\":\"大家好！我們是昊德經絡按摩館官網，希望透過我們的官網，讓大家更了解推拿館的服務內容，可以進行線上預約，選擇適合的按摩師傅與項目。我們還提供3D人體經絡圖及測驗，讓大家更直觀的了解經絡理論與保健方法。對於無法親自到場的顧客也可透過線上諮詢與老闆同步溝通。網站上的教學文章涵蓋各種按摩技巧與經絡知識，希望幫助大家在日常生活中輕鬆保健！\"}', '109534206', '2025-12-10 22:19:39', NULL, NULL, 'uknim', '2025-12-10 22:20:35', 1, '2025-12-10 22:20:44');
...
CREATE TABLE `requirementdata` (
  ...
  `req_count` varchar(50) DEFAULT NULL COMMENT '需求量化',
...
(7, '召集人', '在專題中很大的影響力', '2026-01-07 22:47:03', 1);
...
CREATE TABLE `teacherteamlimit` (
  ...
  `max_count` tinyint(1) NOT NULL COMMENT '團隊數量',
  `ttl_created_at` datetime DEFAULT current_timestamp() COMMENT '建立時間',
  `ttl_updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '最後更新時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `teacherteamlimit` (`ttl_ID`, `ttl_u_ID`, `cohort_ID`, `max_count`, `ttl_created_at`, `ttl_updated_at`) VALUES
(1, 'wennie', 3, 3, '2026-01-02 15:33:30', '2026-01-02 15:33:30'),
(2, 'beckchou', 3, 4, '2026-01-02 16:34:37', '2026-01-08 13:12:25');
...
(1, '資管科學會活動管理系統', '[\"110534107\",\"110534109\",\"110534118\"]\r\n', 'beckchou', 'uploads/team_apply/apply_110534211_1767799.jpg', '{\"group_id\":\"1\",\"comment\":\"\"}\r\n', 3, '110534107', 'uknim', NULL, '2026-01-08 06:03:09', NULL),
(10, '金齁甲調查局', '[\"110534237\",\"110534238\",\"110534224\",\"110534211\"]', 'yang', 'uploads/team_apply/apply_110534211_1767799360.jpg', '{\"group_id\":\"2\",\"comment\":\"\"}', 3, '110534211', 'uknim', '2026-01-08 13:19:01', '2026-01-08 13:19:01', '');
...
(11, 2, '金齁甲調查局', 3, 1, '2026-01-08 13:19:01', 'uploads/team_apply/apply_110534211_1767799360.jpg');
...
(11, '110534211', 1, '2026-01-08 13:19:01', 'uploads/team_apply/apply_110534211_1767799360.jpg'),
(11, '110534224', 1, '2026-01-08 13:19:01', 'uploads/team_apply/apply_110534211_1767799360.jpg'),
(11, '110534237', 1, '2026-01-08 13:19:01', 'uploads/team_apply/apply_110534211_1767799360.jpg'),
(11, '110534238', 1, '2026-01-08 13:19:01', 'uploads/team_apply/apply_110534211_1767799360.jpg'),
(11, 'yang', 1, '2026-01-08 13:19:01', 'uploads/team_apply/apply_110534211_1767799360.jpg');

-- --------------------------------------------------------

--
-- 資料表結構 `teammemberlimit`
--

CREATE TABLE `teammemberlimit` (
  `ttm_ID` int(11) NOT NULL COMMENT '控管成員數量設定ID',
  `cohort_ID` int(11) NOT NULL COMMENT '屆別ID',
  `min_count` tinyint(4) NOT NULL DEFAULT 1 COMMENT '最低成員數',
  `max_count` tinyint(4) NOT NULL DEFAULT 1 COMMENT '成員上限',
  `ttm_created_at` datetime NOT NULL DEFAULT current_timestamp() COMMENT '建立時間',
  `ttm_update_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT '最後更新時間'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='組別成員數量控管';
...
('108534140', '1', '徐莉婷', '108534140@stu.ukn.edu.tw', NULL, NULL, 3, NULL),
('109534201', '1', '林恩宇', '109534201@stu.ukn.edu.tw', '我站在雲林', NULL, 3, '2025-11-06 11:28:35'),
('109534206', '1', '蓁蓁咪', '109534206@stu.ukn.edu.tw', '早上沒事，晚上台中市', NULL, 3, '2025-11-06 11:28:35'),
('109534207', '1', '書嫻桑', '109534207@stu.ukn.edu.tw', '', NULL, 3, '2025-11-06 11:28:35'),
('110511114', '1', '陳珈宣', '110511114@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534101', '1', '林宜伶', '110534101@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534104', '1', '葉芃孝', '110534104@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534105', '1', '顏劭沂', '110534105@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534107', '1', '唐佳臻', '110534107@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534108', '1', '林妍妡', '110534108@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534109', '1', '蕭鈺萱', '110534109@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534110', '1', '陳宥瑋', '110534110@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534113', '1', '林永欽', '110534113@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534114', '1', '楊勝維', '110534114@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534115', '1', '郭孟璇', '110534115@stu.ukn.edu.tw', NULL, NULL, 1, '2025-12-11 09:57:57'),
('110534116', '1', '劉承昀', '110534116@stu.ukn.edu.tw', NULL, NULL, 1, NULL),
('110534118', '1', '潘星穎', '110534118@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534119', '1', '伏詠琳', '110534119@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534120', '1', '石盛文', '110534120@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534123', '1', '楊翔安', '110534123@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534125', '1', '王育圻', '110534125@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534132', '1', '郭芷妍', '110534132@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534133', '1', '鍾雨凝', '110534133@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534134', '1', '陳　湛', '110534134@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534136', '1', '張建翊', '110534136@stu.ukn.edu.tw', NULL, NULL, 1, NULL),
('110534137', '1', '張家禎', '110534137@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534138', '1', '郭晉銘', '110534138@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534145', '1', '黃冠錡', '110534145@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:19'),
('110534201', '1', '黃堃巽', '110534201@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534202', '1', '賴逢尼', '110534202@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534205', '1', '邱芷彤', '110534205@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534206', '1', '尤思婷', '110534206@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534207', '1', '蔡沁妤', '110534207@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534209', '1', '林奕璁', '110534209@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534210', '1', '汪俊成', '110534210@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534211', '1', '陳思維', '110534211@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534212', '1', '賴定宏', '110534212@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534213', '1', '許登瑞', '110534213@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534215', '1', '張莉翎', '110534215@stu.ukn.edu.tw', '嗨莉莉莉', 'u_img_110534215_1763675534.jpg', 1, '2025-11-06 11:28:35'),
('110534216', '1', '陳淯玲', '110534216@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534217', '1', '陳省恩', '110534217@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534221', '1', '羅勻辰', '110534221@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534224', '1', '蔡承達', '110534224@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534225', '1', '由世全', '110534225@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534226', '1', '林圻恩', '110534226@stu.ukn.edu.tw', '竟佔', NULL, 1, NULL),
('110534228', '1', '謝秉哲', '110534228@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-21 17:15:56'),
('110534229', '1', '吳嘉緯', '110534229@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-21 17:15:56'),
('110534231', '1', '凱饒婷', '110534231@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534232', '1', '蔡愷慈', '110534232@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-21 17:15:56'),
('110534233', '1', '李玉馨', '110534233@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-21 17:15:56'),
('110534235', '1', '周佳儀', '110534235@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534236', '1', '林奕廷', '110534236@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534237', '1', '蔡宏恩', '110534237@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-21 17:15:56'),
('110534238', '1', '黃哲渝', '110534238@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-21 17:15:56'),
('110534242', '1', '郭紘丞', '110534242@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('110534244', '1', '馬嫚蔆', '110534244@stu.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('adm_uknim1', '1', '召集人1', '', NULL, NULL, 1, '2026-01-08 05:45:40'),
('adm_uknim2', '1', '召集人2', '', NULL, NULL, 1, '2026-01-08 05:45:40'),
('beckchou', '1', '建宇貝殼', 'beckchou@g.ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('claire', '1', '益西曲珍', 'amy0718@ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:32'),
('jack', '1', '李栢松', 'jacklee521@ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:32'),
('scottli', '1', '李岳倫', 'scottli@ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:32'),
('stanleyh', '1', '謝樹明', 'stanleyh@ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:32'),
('system', '1', '系統', '', NULL, NULL, 1, '2025-11-06 11:28:35'),
('test', '1', 'test', '', NULL, NULL, 1, '2025-12-09 15:03:27'),
('test1', '1', 'test1', '', NULL, NULL, 3, NULL),
('test2', '1', 'test2', 'test2@stu.ukn.edu.tw', NULL, NULL, 1, NULL),
('test3', '1', '2', 'test3@stu.ukn.edu.tw', NULL, NULL, 2, NULL),
('toshiko', '1', '嚴竹華', 'echoyan@ukn.edu.tw', NULL, NULL, 1, '2025-11-06 11:28:35'),
('uknim', '1', '科辦', '', NULL, NULL, 1, '2025-11-06 11:28:35'),
('wennie', '1', '朱錦文', 'wennie@ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:32'),
('yang', '1', '楊景琦', 'yang@ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:32'),
('yfpeng', '1', '彭賓鈺', 'yfpeng@ukn.edu.tw', NULL, NULL, 1, '2025-11-24 09:58:32');
...
--
-- 資料表索引 `changerecordsdata`
--
ALTER TABLE `changerecordsdata`
  ADD PRIMARY KEY (`cr_ID`),
  ADD KEY `idx_changerec_rd` (`rd_ID`),
  ADD KEY `idx_changerec_user` (`cr_u_ID`);
...
-- 資料表索引 `exresultdata`
--
ALTER TABLE `exresultdata`
  ADD PRIMARY KEY (`sfd_ID`),
  ADD KEY `idx_exresultdata_team` (`sfd_team_ID`),
  ADD KEY `idx_exresultdata_user` (`sfd_u_ID`);

--
-- 資料表索引 `exresultddata`
--
ALTER TABLE `exresultddata`
  ADD PRIMARY KEY (`rd_ID`),
  ADD KEY `idx_exresultd_sfd` (`sfd_ID`),
  ADD KEY `idx_exresultd_owner` (`rd_u_ID_a`),
  ADD KEY `idx_exresultd_finisher` (`rd_u_ID_b`),
  ADD KEY `idx_exresultd_status` (`rd_status`);
...
--
-- 資料表索引 `teammemberlimit`
--
ALTER TABLE `teammemberlimit`
  ADD PRIMARY KEY (`ttm_ID`),
  ADD UNIQUE KEY `uk_teammemberlimit_cohort` (`cohort_ID`);
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `changerecordsdata`
--
ALTER TABLE `changerecordsdata`
  MODIFY `cr_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號';
...
--
ALTER TABLE `docsubdata`
  MODIFY `sub_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '申請ID', AUTO_INCREMENT=3;
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `exresultdata`
--
ALTER TABLE `exresultdata`
  MODIFY `sfd_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號';

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `exresultddata`
--
ALTER TABLE `exresultddata`
  MODIFY `rd_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號';
...
--
ALTER TABLE `teamapply`
  MODIFY `tap_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '流水號', AUTO_INCREMENT=11;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `teamdata`
--
ALTER TABLE `teamdata`
  MODIFY `team_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '團隊ID', AUTO_INCREMENT=12;

--
-- 使用資料表自動遞增(AUTO_INCREMENT) `teammemberlimit`
--
ALTER TABLE `teammemberlimit`
  MODIFY `ttm_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '控管成員數量設定ID';
...
--
-- 資料表的限制式 `changerecordsdata`
--
ALTER TABLE `changerecordsdata`
  ADD CONSTRAINT `fk_changerec_rd` FOREIGN KEY (`rd_ID`) REFERENCES `exresultddata` (`rd_ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_changerec_user` FOREIGN KEY (`cr_u_ID`) REFERENCES `userdata` (`u_ID`) ON UPDATE CASCADE;
...
--
-- 資料表的限制式 `exresultdata`
--
ALTER TABLE `exresultdata`
  ADD CONSTRAINT `fk_exresultdata_team` FOREIGN KEY (`sfd_team_ID`) REFERENCES `teamdata` (`team_ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_exresultdata_user` FOREIGN KEY (`sfd_u_ID`) REFERENCES `userdata` (`u_ID`) ON UPDATE CASCADE;

--
-- 資料表的限制式 `exresultddata`
--
ALTER TABLE `exresultddata`
  ADD CONSTRAINT `fk_exresultd_finisher` FOREIGN KEY (`rd_u_ID_b`) REFERENCES `userdata` (`u_ID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_exresultd_owner` FOREIGN KEY (`rd_u_ID_a`) REFERENCES `userdata` (`u_ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_exresultd_sfd` FOREIGN KEY (`sfd_ID`) REFERENCES `exresultdata` (`sfd_ID`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_exresultd_status` FOREIGN KEY (`rd_status`) REFERENCES `statusdata` (`status_ID`) ON UPDATE CASCADE;
...
--
-- 資料表的限制式 `teammemberlimit`
--
ALTER TABLE `teammemberlimit`
  ADD CONSTRAINT `fk_teammemberlimit_cohort` FOREIGN KEY (`cohort_ID`) REFERENCES `cohortdata` (`cohort_ID`) ON UPDATE CASCADE;
