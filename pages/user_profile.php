...
<body class="p-5">
  <div class="container">
    ...
    <div class="card-body">
<?php
$defaultImg = "https://cdn-icons-png.flaticon.com/512/1144/1144760.png";
$img = !empty($data['u_img']) 
    ? "headshot/" . $data['u_img'] 
    : $defaultImg;
?>
<div class="mb-3 text-center">
    <img id="avatarPreview" src="<?= $img ?>" data-default="<?= $defaultImg ?>" class="avatar-img border">
</div>
    ...
    <form id="profileForm" method="post" action="../api.php?do=update_profile" enctype="multipart/form-data">
      ...
      <div class="mb-3 d-none" id="avatarUpload">
        ...
        <input type="file" class="form-control" name="u_img" id="avatarInput" accept="image/*" onchange="previewAvatar(event)">
  ...
  <script>
    ...
    document.getElementById('btnClearAvatar').addEventListener('click', function(e) {
      ...
      if (img) {
        const fallback = img.dataset.default || 'https://cdn-icons-png.flaticon.com/512/1144/1144760.png';
        img.src = fallback;
      }
    });
  </script>
