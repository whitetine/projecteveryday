...
$edit_u_ID = $_GET['u_ID'] ?? null;
$isNew     = empty($edit_u_ID);
...
<div class="edit-user-container">
  ...
  <div class="edit-card">
    <form method="post" action="pages/somefunction/update_user.php" enctype="multipart/form-data" id="editUserForm">
      <input type="hidden" name="mode" value="<?= $isNew ? 'create' : 'update' ?>">
      <input type="hidden" name="u_ID_original" value="<?= htmlspecialchars($edit_u_ID ?? '', ENT_QUOTES) ?>">
                ...
                <div class="col-12 col-sm-4">
                  ...
                  <select name="role_id" class="form-select form-select-enhanced" required>
                    ...
                    <?php foreach ($roles as $r): ?>
                      <?php
                      // 若登入者是 role_ID = 2(科辦)，就不顯示「主任」「科辦」
                      if ($_SESSION["role_ID"] == 2 && in_array($r['role_name'], ['主任', '科辦','系統'])) {
                        continue;
                      }
                      ?>
